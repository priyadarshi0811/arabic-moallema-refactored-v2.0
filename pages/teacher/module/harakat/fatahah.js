  ...
  return (
    <div className="w-full  ">
      ...
      <div className=" w-full p-2 rounded-md  flex flex-row justify-center   pt-3">
        <div className="mx-5">
          <Link href="/teacher/module/harakat/activity">
            <Button variant="contained" className="text-dark-purple bg-white " style={{marginRight:10}}>
              Activity
            </Button>
          </Link>
          <Link href="/teacher/module/harakat/how-to-read-1">
