    ...
    >
      <div className="bg-white rounded-3xl">
        <div className=" w-full p-5 rounded-md  flex flex-row justify-between    pt-10">
          ...
          <div>
            <Link href="/teacher/module/almadood" className="mx-5">
              <Button
                variant="contained"
        ...
        <div className="p-10">
          <div className="mx-10  bg-dark-purple   text-center text-dark-purple h-full rounded-3xl  ">
            ...
            <div className="bg-white rounded-3xl border-b-8 border-cyan-400">
              ...
              <p className="py-5 text-lg font-medium">
                When there is a fatha before alif we stretch it for two counts
                and it is called alif madd. An alif can also be written as a
                standing fatha. Alif Maddah (الف المدية الصغيرة) is a letter of
                the Arabic alphabet that represents the same sound as Alef with
                Madda. It is written as a small Alif with a Maddah diacritic on
                top, and it is used to represent the long "a" sound at the
                beginning of a word or after a hamza (ء), which represents a
                glottal stop. For example, أُمَّة (umma) means "nation" in
                Arabic, and the Alif Maddah is used to indicate the long "a"
          ...
          <div className="mt-5 w-full flex justify-center">
            <Link href="/teacher/module/almadood/alif/how-to-read-1">
              <Button
                variant="contained"
